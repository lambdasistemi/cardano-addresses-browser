...
// Serialized XPrv is 96 bytes (64 prv + 32 chain code).
// The WASM returns full xprvToBytes which is also 96 bytes.
// For bech32 encoding we use the 96-byte serialized form.
